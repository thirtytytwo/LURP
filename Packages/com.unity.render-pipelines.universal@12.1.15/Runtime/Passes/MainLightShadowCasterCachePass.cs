...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    /// </summary>
    public class MainLightShadowCasterCachePass : ScriptableRenderPass
    {
        ...
        private int m_PreShadowmapWidth = 0;
        private int m_PreShadowmapHeight = 0;
        ...
        public MainLightShadowCasterCachePass(RenderPassEvent evt)
        {
        ...
        public bool Setup(ref RenderingData renderingData)
        {
            ...
            for (int cascadeIndex = 0; cascadeIndex < m_ShadowCasterCascadesCount; ++cascadeIndex)
            {
                ...
                //分帧更新
                if(cascadeIndex != 0 && m_Frame % 3 != (cascadeIndex - 1)) continue;
        ...
        {
            //如果图片尺寸改变，就需要重新生成阴影贴图
            if (m_PreShadowmapHeight != renderTargetHeight || m_PreShadowmapWidth != renderTargetWidth)
            {
                CleanShadowmap();
                ...
                m_PreShadowmapHeight = renderTargetHeight;
                m_PreShadowmapWidth = renderTargetWidth;
            }
        }
        ...
        bool SetupForEmptyRendering(ref RenderingData renderingData)
        {
            ...
            m_PreShadowmapHeight = 1;
            m_PreShadowmapWidth = 1;
