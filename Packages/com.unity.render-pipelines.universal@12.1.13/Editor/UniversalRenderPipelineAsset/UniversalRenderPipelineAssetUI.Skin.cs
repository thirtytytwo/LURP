...
namespace UnityEditor.Rendering.Universal
{
    internal partial class UniversalRenderPipelineAssetUI
    {
        public static class Styles
        {
            ...
            public static GUIContent requireDepthTextureModeText = EditorGUIUtility.TrTextContent("Depth Texture Mode", "The depth texture mode that is used for the depth texture.");
